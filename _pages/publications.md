...
.pub-list {
  margin: 1.6em 0 0;
  --pub-ok: #2e7d5b;  --pub-ok-bg: #e4f1ea;
  --pub-rev: #a4671a; --pub-rev-bg: #f6ecdb;
  --pub-hover: #f2f5f6;
  --pub-sep: #c9ced2;
}
html[data-theme="dark"] .pub-list {
  --pub-ok: #6fce9f;  --pub-ok-bg: rgba(111, 206, 159, .15);
  --pub-rev: #e0a765; --pub-rev-bg: rgba(224, 167, 101, .16);
...
.pub-list a.pub:hover .pub-title { color: var(--global-link-color); }
.pub-list a.pub:hover .pub-arrow { opacity: 1; transform: translateX(0); }
.pub-list a.pub:focus-visible { outline: 2px solid var(--global-link-color); outline-offset: 2px; }
.pub-meta {
...
.pub-auth { font-size: .85rem; line-height: 1.5; color: var(--global-text-color-light); }
.pub-auth strong { color: var(--global-text-color); font-weight: 700; }
.pub-badge {
...
.pub-badge.is-pub { color: var(--pub-ok); background: var(--pub-ok-bg); }
.pub-badge.is-rev { color: var(--pub-rev); background: var(--pub-rev-bg); }
.pub-badge.is-thesis { color: var(--global-text-color-light); background: var(--pub-hover); }
.pub-arrow {
  align-self: center;
  font-size: 1.1rem;
  color: var(--global-link-color);
